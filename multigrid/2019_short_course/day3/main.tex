...
\only<1>{
\begin{center}
\includegraphics[width=0.7\textwidth]{../figures/amgCoarsening} % TODO fix all figures
\end{center}}
\only<2>{
\begin{center}
\includegraphics[width=0.7\textwidth]{../figures/amgCoarsening-2} % TODO fix all figures
\end{center}}
\only<3>{
\begin{center}
\includegraphics[width=0.7\textwidth]{../figures/amgCoarsening-3} % TODO fix all figures
\end{center}}
\only<4>{
\begin{center}
\includegraphics[width=0.7\textwidth]{../figures/amgCoarsening-4} % TODO fix all figures
\end{center}}
\only<5>{
\begin{center}
\includegraphics[width=0.7\textwidth]{../figures/amgCoarsening-5} % TODO fix all figures
\end{center}}
\only<6>{
\begin{center}
\includegraphics[width=0.7\textwidth]{../figures/amgCoarsening-6} % TODO fix all figures
\end{center}}
\only<7>{
\begin{center}
\includegraphics[width=0.7\textwidth]{../figures/amgCoarsening-7} % TODO fix all figures
\end{center}}
\only<8>{
\begin{center}
\includegraphics[width=0.7\textwidth]{../figures/amgCoarsening-8} % TODO fix all figures
\end{center}}
\only<9>{
\begin{center}
\includegraphics[width=0.7\textwidth]{../figures/amgCoarsening-9} % TODO fix all figures
\end{center}}
\only<10>{
\begin{center}
\includegraphics[width=0.7\textwidth]{../figures/amgCoarsening-10} % TODO fix all figures
\end{center}}
\only<11>{
\begin{center}
\includegraphics[width=0.7\textwidth]{../figures/amgCoarsening-11} % TODO fix all figures
\end{center}}
