...
\end{block}
\begin{center}
\includegraphics[width=0.5\textwidth]{../figures/jacobiModeDamping} % TODO fix all figures
\end{center}
\end{frame}
...
\begin{frame}{Multigrid cycles}
\begin{center}
% \includegraphics[width=0.7\textwidth]{../figures/Vcycle} TODO
\end{center}
\end{frame}
...
\begin{frame}{Multigrid cycles}
\begin{center}
% \includegraphics[width=0.7\textwidth]{../figures/Wcycle} TODO
\end{center}
\end{frame}
...
\begin{frame}{Multigrid cycles}
\begin{center}
% \includegraphics[width=0.7\textwidth]{../figures/FMGcycle} TODO
\end{center}
\end{frame}
