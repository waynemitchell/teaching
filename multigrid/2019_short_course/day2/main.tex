...
\eq{
   \mathbf{x} = \sum_{k=1}^N \langle \mathbf{x}, \mathbf{v}_k \rangle \mathbf{v}_k 
}
...
\eq{
   ...
   &= 1 - 2\sin^2\left(\frac{k\pi}{2(N+1)}\right)
}
\eit
\end{block}
\end{frame}
...
\eq{
   ...
   &= E^i\left(\sum_{k=1}^N \langle \mathbf{e}^{(0)}, \mathbf{v}_k \rangle \mathbf{v}_k\right) \\
   &= \sum_{k=1}^N \tilde\lambda_k^i \langle \mathbf{e}^{(0)}, \mathbf{v}_k \rangle \mathbf{v}_k
}
...
\eq{
   \tilde\lambda_k = 1 - 2\sin^2\left(\frac{k\pi}{2(N+1)}\right)
}
\eit
\end{block}
\begin{center}
...
\eq{
   \tilde\lambda_k &= 1 - 2\omega\sin^2\left(\frac{k\pi}{2(N+1)}\right)
}
\eit
\end{block}
\end{frame}
